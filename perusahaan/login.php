...
<html lang="en">
    <head>
        ...
        <title>Lowker Unsiq - Perusahaan</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Login - Perusahaan</h3></div>
                                    <div class="card-body">
                                        <form action="login_perusahaan.php" method="POST">
